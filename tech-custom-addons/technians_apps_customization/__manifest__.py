{
    ...
    'license': '',
    'depends': ['base','crm','maintenance','sale_management','hr_recruitment','hr_employee_updation','project','sales_team','whatsapp_integration_technians','project_timesheet_holidays'],
    'data': [
